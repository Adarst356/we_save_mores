class ReferralResponse {
  ...
  List<RefferalImage>? refferalImage;
  ...
  ReferralResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['refferalImage'] != null) {
      refferalImage = <RefferalImage>[];
      json['refferalImage'].forEach((v) {
        refferalImage!.add(RefferalImage.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (refferalImage != null) {
      data['refferalImage'] = refferalImage!.map((v) => v.toJson()).toList();
    }
...
class RefferalImage {
  ...
  String? siteFileName;
  dynamic popupResourceUrl;
  dynamic popupFileName;
  ...
  RefferalImage.fromJson(Map<String, dynamic> json) {
    url = json['url'];
    refUrl = json['refUrl'];
    type = json['type'];
    opType = json['opType'];
    ...
    siteResourceUrl = json['siteResourceUrl'];
    siteFileName = json['siteFileName'];
    popupResourceUrl = json['popupResourceUrl'];
    popupFileName = json['popupFileName'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['siteResourceUrl'] = siteResourceUrl;
    data['siteFileName'] = siteFileName;
    data['popupResourceUrl'] = popupResourceUrl;
    data['popupFileName'] = popupFileName;
