class GetBannerResponse {
  ...
  GetBannerResponse.fromJson(Map<String, dynamic> json) {
    if (json['bannerUrl'] != null) {
      bannerUrl = (json['bannerUrl'] as List)
          .map((v) => BannerUrl.fromJson(v))
          .toList();
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (bannerUrl != null) {
      data['bannerUrl'] = bannerUrl!.map((v) => v.toJson()).toList();
    }
