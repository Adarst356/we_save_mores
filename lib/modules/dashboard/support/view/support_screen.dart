            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Get.toNamed(AppRoutes.supportNumbers, arguments: {"serviceId":1});
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.toNamed(AppRoutes.supportNumbers, arguments: {"serviceId":3});
                    },
                    child: customInfoButton(
                      icon: Icons.phone,
                      title: "DTH TollFree",
        ...
        child: Column(
          ...
          children: [
            ...
            if ((data?.customerCareMobileNos ?? "").trim().isNotEmpty)
              _contactRow(
                data?.customerCareMobileNos ?? "",
                "assets/svg/postpaid.svg",
                1,
              ),
            ...
            if ((data?.customerPhoneNos ?? "").trim().isNotEmpty)
              _contactRow(
                data?.customerPhoneNos ?? "",
                "assets/svg/landline.svg",
                2,
              ),
